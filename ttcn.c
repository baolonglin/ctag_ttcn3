...
static kindOption ttcnKinds [] = {
	{ TRUE, 'c', "module", "module definition" },
	{ TRUE, 't', "type", "type definition" },
	{ TRUE, 'd', "const", "constant definition" },
	{ TRUE, 'd', "template", "template definition" },
	{ TRUE, 'f', "function", "function definition" },
	{ TRUE, 'f', "signature", "signature definition" },
	{ TRUE, 'f', "testcase", "testcase definition" },
	{ TRUE, 'f', "altstep", "altstep definition" },
	{ TRUE, 'c', "group", "group definition" },
	{ TRUE, 'p', "modulepar", "module parameter definition" },
	{ TRUE, 'v', "var", "variable instance" },
	{ TRUE, 'v', "timer", "timer instance" },
	{ TRUE, 'm', "port", "port instance" },
